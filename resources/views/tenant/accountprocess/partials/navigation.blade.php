...
<header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div class="container-fluid navigation-style">
            ...
            <!-- Buttons (always visible, outside menu) -->
            <div class="d-flex gap-2 ms-3">
                <a href="#" class="btn btn-outline-secondary fw-semibold" disabled>Tenant</a>
                <a href="{{ route('landlord-Login') }}" class="btn btn-primary fw-semibold">Landlord</a>
            </div>
        </div>
    </nav>

    <!-- Offcanvas (Mobile Sidebar - links only, no buttons) -->
    <div class="offcanvas offcanvas-start bg-light" tabindex="-1" id="mobileNav" aria-labelledby="mobileNavLabel">
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav gap-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle fw-semibold text-black"
                        href="{{ route('landingpage') }}" id="aboutUsDropdownMobile"
                        role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-info-circle-fill me-2 text-black"></i> About Us
                    </a>
